...
public class TestPerformance {
   ...
   * @Ignore
   * 
   * @Test public void highVolumeTrackLocation() { GpsUtil gpsUtil = new
   ...
   * finishes within 15 // minutes InternalTestHelper.setInternalUserNumber(100);
   ...
   * 
   * StopWatch stopWatch = new StopWatch(); stopWatch.start(); for (User user :
   * allUsers) { tourGuideService.trackUserLocation(user); } stopWatch.stop();
   ...
   * @Ignore
   * 
   * @Test public void highVolumeGetRewards() { GpsUtil gpsUtil = new GpsUtil();
   * RewardsService rewardsService = new RewardsService(gpsUtil, new
   * RewardCentral());
   * 
   * // Users should be incremented up to 100,000, and test finishes within 20 //
   * minutes InternalTestHelper.setInternalUserNumber(100); StopWatch stopWatch =
   * new StopWatch(); stopWatch.start(); TourGuideService tourGuideService = new
   * TourGuideService(gpsUtil, rewardsService);
   * 
   * Attraction attraction = gpsUtil.getAttractions().get(0); List<User> allUsers
   ...
   * stopWatch.stop(); tourGuideService.tracker.stopTracking();
   * 
